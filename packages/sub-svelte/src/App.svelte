<script>
  ...
  import Details from "./pages/Userdetail.svelte";
  import About from "./pages/About.svelte";
  export let url = "";
  export let basepath = "/sub-svelte";
</script>
    ...
    <div class="px-4 py-3">
      <div class="flex items-center">
        <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
          <li>
            <Link
              class="text-gray-900 dark:text-white hover:underline w-6 h-5 flex"
              to="/sub-svelte/"
            >
